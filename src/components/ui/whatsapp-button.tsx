...
export function WhatsAppButton() {
    return (
        <Link
            ...
            className="fixed bottom-6 right-6 z-50 flex items-center justify-center w-14 h-14 rounded-full shadow-lg bg-[#25D366] hover:bg-[#20bd5a] transition-all duration-300 hover:scale-110 group"
        >
            {/* WhatsApp SVG icon */}
            <svg
